...
if ENV:
    ...
    from kaveriprobot.config import Development as Config
    TOKEN = Config.TOKEN
...
telethn = TelegramClient("kaveriprobot", API_ID, API_HASH)
...
from kaveriprobot.modules.helper_funcs.handlers import (CustomCommandHandler,
