...
import kaveriprobot.modules.sql.notes_sql as sql
from kaveriprobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from kaveriprobot.__main__ import DATA_IMPORT
from kaveriprobot.modules.helper_funcs.chat_status import user_admin
from kaveriprobot.modules.helper_funcs.alternate import typing_action

# from kaveriprobot.modules.rules import get_rules
import kaveriprobot.modules.sql.rules_sql as rulessql

# from kaveriprobot.modules.sql import warns_sql as warnssql
import kaveriprobot.modules.sql.blacklist_sql as blacklistsql
from kaveriprobot.modules.sql import disable_sql as disabledsql

# from kaveriprobot.modules.sql import cust_filters_sql as filtersql
# import kaveriprobot.modules.sql.welcome_sql as welcsql
import kaveriprobot.modules.sql.locks_sql as locksql
from kaveriprobot.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @kaveriprobot_updates"
            )
...
def export_data(update, context):
    ...
    f = open("kaveriprobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("kaveriprobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `kaveriprobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("kaveriprobot{}.backup".format(chat_id))  # Cleaning file
