...
from kaveriprobot import (DEV_USERS, OWNER_ID, SUDO_USERS, SUPPORT_CHAT,
                          SUPPORT_USERS, TIGER_USERS, WHITELIST_USERS,
                          dispatcher)
from kaveriprobot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'kaveriprobot/elevated_users.json')
