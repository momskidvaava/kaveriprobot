...
from kaveriprobot import (DEL_CMDS, DEV_USERS, SUDO_USERS, SUPPORT_CHAT,
                          SUPPORT_USERS, TIGER_USERS, WHITELIST_USERS,
                          dispatcher)
from kaveriprobot.mwt import MWT
...
def sudo_plus(func):
    ...
    def is_sudo_plus_func(update: Update, context: CallbackContext, *args,
        ...
        if user and is_sudo_plus(chat, user.id):
            ...
            update.effective_message.reply_text(
                "Who this non-admin telling me what to do ? do You want a punch?")
...
def bot_admin(func):
    ...
    def is_admin(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            not_admin = "I'm not admin! - EEEEEE"
        else:
...
from kaveriprobot.modules import connection
