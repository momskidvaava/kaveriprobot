...
DEFAULT_WELCOME_MESSAGES = [
    "{first} സ്വാഗതം ചെയ്യുന്നു !",  #Discord welcome messages copied
    "എന്നാൽ പിന്നെ തുടങ്ങിയാലോ ..... {first}",
    "A wild {first} appeared.",
    "{first} . താങ്കളെ ഹാർദ്ദവമായി സ്വഗതം ചെയ്യുന്നു !",
    ...
    "Welcome, {first}. please introduce yourself ,.",
    "Welcome, {first}. We were expecting you ( ͡° ͜ʖ ͡°)",
    "Welcome, {first}. താങ്കളെ ദയവായി പരിചയപ്പെടുത്താം.",
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "{first} പോയി അല്ലെ ? സാരമില്ല ",
    "{first} ടാറ്റ ..... ബിർള ...... .",
    "{first} പോയത് നന്നായി .ഇല്ലെങ്കിൽ പറഞ്ഞു വിട്ടെനെ.",
