...
from kaveriprobot import (DEV_USERS, OWNER_ID, SUDO_USERS, SUPPORT_USERS,
                          TIGER_USERS, WHITELIST_USERS, INFOPIC, dispatcher, sw)
from kaveriprobot.__main__ import STATS, TOKEN, USER_INFO
import kaveriprobot.modules.sql.userinfo_sql as sql
from kaveriprobot.modules.disable import DisableAbleCommandHandler
from kaveriprobot.modules.sql.global_bans_sql import is_user_gbanned
from kaveriprobot.modules.sql.afk_sql import is_afk, check_afk_status
from kaveriprobot.modules.sql.users_sql import get_user_num_chats
from kaveriprobot.modules.sql.feds_sql import get_user_fbanlist
from kaveriprobot.modules.helper_funcs.chat_status import sudo_plus
from kaveriprobot.modules.helper_funcs.extraction import extract_user
from kaveriprobot import telethn as SaitamaTelethonClient, TIGER_USERS, SUDO_USERS, SUPPORT_USERS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/kaveriprobot_updates">?</a>]'.format(
            bot.username)
